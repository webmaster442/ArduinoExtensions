...
inline void WriteD14(int value)
{
	if (value) PORTJ |= 1 << 1;
	else PORTJ &= ~(1 << 1);
}
...
inline void WriteD15(int value)
{
	if (value) PORTJ |= 1 << 0;
	else PORTJ &= ~(1 << 0);
}
...
inline void WriteD16(int value)
{
	if (value) PORTH |= 1 << 1;
	else PORTH &= ~(1 << 1);
}
...
inline void WriteD17(int value)
{
	if (value) PORTH |= 1 << 0;
	else PORTH &= ~(1 << 0);
}
...
inline void WriteD18(int value)
{
	if (value) PORTD |= 1 << 3;
	else PORTD &= ~(1 << 3);
}
...
inline void WriteD19(int value)
{
	if (value) PORTD |= 1 << 2;
	else PORTD &= ~(1 << 2);
}
...
inline void WriteD20(int value)
{
	if (value) PORTD |= 1 << 1;
	else PORTD &= ~(1 << 1);
}
...
inline void WriteD21(int value)
{
	if (value) PORTD |= 1 << 0;
	else PORTD &= ~(1 << 0);
}
...
inline void WriteD22(int value)
{
	if (value) PORTA |= 1 << 0;
	else PORTA &= ~(1 << 0);
}
...
inline void WriteD23(int value)
{
	if (value) PORTA |= 1 << 1;
	else PORTA &= ~(1 << 1);
}
...
inline void WriteD24(int value)
{
	if (value) PORTA |= 1 << 2;
	else PORTA &= ~(1 << 2);
}
...
inline void WriteD25(int value)
{
	if (value) PORTA |= 1 << 3;
	else PORTA &= ~(1 << 3);
}
...
inline void WriteD26(int value)
{
	if (value) PORTA |= 1 << 4;
	else PORTA &= ~(1 << 4);
}
...
inline void WriteD27(int value)
{
	if (value) PORTA |= 1 << 5;
	else PORTA &= ~(1 << 5);
}
...
inline void WriteD28(int value)
{
	if (value) PORTA |= 1 << 6;
	else PORTA &= ~(1 << 6);
}
...
inline void WriteD29(int value)
{
	if (value) PORTA |= 1 << 7;
	else PORTA &= ~(1 << 7);
}
...
inline void WriteD30(int value)
{
	if (value) PORTC |= 1 << 7;
	else PORTC &= ~(1 << 7);
}
...
inline void WriteD31(int value)
{
	if (value) PORTC |= 1 << 6;
	else PORTC &= ~(1 << 6);
}
...
inline void WriteD32(int value)
{
	if (value) PORTC |= 1 << 5;
	else PORTC &= ~(1 << 5);
}
...
inline void WriteD33(int value)
{
	if (value) PORTC |= 1 << 4;
	else PORTC &= ~(1 << 4);
}
...
inline void WriteD34(int value)
{
	if (value) PORTC |= 1 << 3;
	else PORTC &= ~(1 << 3);
}
...
inline void WriteD35(int value)
{
	if (value) PORTC |= 1 << 2;
	else PORTC &= ~(1 << 2);
}
...
inline void WriteD36(int value)
{
	if (value) PORTC |= 1 << 1;
	else PORTC &= ~(1 << 1);
}
...
inline void WriteD37(int value)
{
	if (value) PORTC |= 1 << 0;
	else PORTC &= ~(1 << 0);
}
...
inline void WriteD38(int value)
{
	if (value) PORTD |= 1 << 7;
	else PORTD &= ~(1 << 7);
}
...
inline void WriteD39(int value)
{
	if (value) PORTG |= 1 << 2;
	else PORTG &= ~(1 << 2);
}
...
inline void WriteD40(int value)
{
	if (value) PORTG |= 1 << 1;
	else PORTG &= ~(1 << 1);
}
...
inline void WriteD41(int value)
{
	if (value) PORTG |= 1 << 0;
	else PORTG &= ~(1 << 0);
}
...
inline void WriteD42(int value)
{
	if (value) PORTL |= 1 << 7;
	else PORTL &= ~(1 << 7);
}
...
inline void WriteD43(int value)
{
	if (value) PORTL |= 1 << 6;
	else PORTL &= ~(1 << 6);
}
...
inline void WriteD44(int value)
{
	if (value) PORTL |= 1 << 5;
	else PORTL &= ~(1 << 5);
}
...
inline void WriteD45(int value)
{
	if (value) PORTL |= 1 << 4;
	else PORTL &= ~(1 << 4);
}
...
inline void WriteD46(int value)
{
	if (value) PORTL |= 1 << 3;
	else PORTL &= ~(1 << 3);
}
...
inline void WriteD47(int value)
{
	if (value) PORTL |= 1 << 2;
	else PORTL &= ~(1 << 2);
}
...
inline void WriteD48(int value)
{
	if (value) PORTL |= 1 << 1;
	else PORTL &= ~(1 << 1);
}
...
inline void WriteD49(int value)
{
	if (value) PORTL |= 1 << 0;
	else PORTL &= ~(1 << 0);
}
...
inline void WriteD50(int value)
{
	if (value) PORTB |= 1 << 3;
	else PORTB &= ~(1 << 3);
}
...
inline void WriteD51(int value)
{
	if (value) PORTB |= 1 << 2;
	else PORTB &= ~(1 << 2);
}
...
inline void WriteD52(int value)
{
	if (value) PORTB |= 1 << 1;
	else PORTB &= ~(1 << 1);
}
...
inline void WriteA12(int value)
{
	if (value) PORTK |= 1 << 4;
	else PORTK &= ~(1 << 4);
}
...
inline void WriteA13(int value)
{
	if (value) PORTK |= 1 << 5;
	else PORTK &= ~(1 << 5);
}
...
inline void WriteA14(int value)
{
	if (value) PORTK |= 1 << 6;
	else PORTK &= ~(1 << 6);
}
...
inline void WriteA15(int value)
{
	if (value) PORTK |= 1 << 7;
	else PORTK &= ~(1 << 7);
}
